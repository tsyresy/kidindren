...
export default function Deposit() {
    ...
    const handleAmountChange = (e) => {
        ...
        setAmountToPay(baseAmount + commission)
    }
        ...
        try {
            ...
            const { data: transaction, error: transError } = await supabase
                ...
                .insert({
                    ...
                    final_amount_mga: amountToPay,
                    exchange_rate: RATES[formData.currency],
                    mobile_money_transaction_id: formData.transactionId,
                ...
                <Card>
                    <CardContent sx={{ p: 4 }}>
                        <Grid container spacing={3}>
                                ...
                                <Grid item xs={12}>
                                    <Alert severity="info" icon={<CheckCircleIcon />}>
                                        <Typography variant="h6">
                                            Montant à payer : <strong>{amountToPay.toLocaleString('fr-FR')} MGA</strong>
                                        </Typography>
                                        <Typography variant="caption">
                                            Commission ({plan?.commission_rate || 15}%) incluse
                                        </Typography>
                                    </Alert>
                                </Grid>
                            )}
                            ...
                            <Grid item xs={12}>
                                <Card sx={{ background: 'linear-gradient(135deg, #16f98a 0%, #3EF0D0 100%)', color: '#010F1B' }}>
                                    <CardContent>
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                                            <Chip label="037 69 504 76" sx={{ fontWeight: 700, fontSize: '1rem' }} />
                                            <Button
                                                size="small"
                                                startIcon={<ContentCopyIcon />}
                                                onClick={() => copyToClipboard('037 69 504 76')}
                                            >
                                                Copier
                                            </Button>
                                        </Box>
                                        <Typography variant="body2">
                                            <strong>Nom :</strong> Mahay Tsy Resy<br />
                                            <strong>Opérateur :</strong> Orange Money
                                        </Typography>
                                    </CardContent>
                                </Card>
                            </Grid>
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    ...
                                    helperText="Entrez l'ID de votre transaction Mobile Money"
                                />
                            </Grid>
                            ...
                            <Grid item xs={12} md={6}>
                                <TextField
                                    fullWidth
                                    required
                                    label="Votre compte Mobile Money"
